        ...
        >
          <View style={{ ...styles.boxShadow, ...styles.welcomeContainer }}>
            ...
            <ScrollView style={styles.scrollviewStyle}>
                {users.map(user => (
                    <User key={user.userId} id={user.userId} name={user.userName} password={user.userPassword} mail={user.userMail} height={user.userHeight} weight={user.userWeight} navigation={navigation}/>
                ))}
            </ScrollView>
          </View>
        </ImageBackground>
